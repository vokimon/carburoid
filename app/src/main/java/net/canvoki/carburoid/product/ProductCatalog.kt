...
object ProductCatalog {
    ...
    fun productName(apiName: String, context: Context): String {
...
@Composable
fun translateProductName(apiName: String): String {
    return ProductCatalog.productName(apiName)
}

fun translateProductName(apiName: String, context: Context): String {
    return ProductCatalog.productName(apiName, context)
}
