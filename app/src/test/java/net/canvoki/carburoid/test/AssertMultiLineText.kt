...
private fun charLevelDiff(old: String, new: String): Pair<String, String> {
...
private fun contextBefore(lines: List<String>, start: Int, context: Int): List<String> =
    lines.subList(maxOf(0, start - context), start)

private fun contextAfter(lines: List<String>, end: Int, context: Int): List<String> =
    lines.subList(end, minOf(lines.size, end + context))

fun assertEquals(expected: String, actual: String, contextLines: Int = 3) {
